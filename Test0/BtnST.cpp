...
//		[IN]	rpItem
//				A pointer to a RECT structure indicating the allowed paint uparea
//		[IN/OUT]rpTitle
//				A pointer to a CRect object indicating the paint uparea reserved for the
...
//		[OUT]	rpImage
//				A pointer to a CRect object that will receive the uparea available to the image
//
...
void CButtonST::DrawTheIcon(CDC* pDC, BOOL bHasTitle, RECT* rpItem, CRect* rpCaption, BOOL bIsPressed, BOOL bIsDisabled)
{
	...
	pDC->DrawState(	rImage.TopLeft(),
					...
					(bIsDisabled&&!m_bSpecialDisable ? DSS_DISABLED : DSS_NORMAL), 
					(CBrush*)NULL);
} // End of DrawTheIcon
...
void CButtonST::SetSpecialDisable(){
	m_bSpecialDisable = TRUE;
}

void CButtonST::ResetSpecialDisable(){
	m_bSpecialDisable = FALSE;
}
